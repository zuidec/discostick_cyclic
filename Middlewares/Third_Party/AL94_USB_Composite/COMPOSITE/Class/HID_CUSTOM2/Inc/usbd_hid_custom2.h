...
#ifndef __USB_CUSTOMHID2_H
#define __USB_CUSTOMHID2_H
...
#ifndef CUSTOM_HID2_FS_BINTERVAL
#define CUSTOM_HID2_FS_BINTERVAL                      0x05U
...
#define USBD_CUSTOM_HID2_REPORT_DESC_SIZE             44U
#endif /* USBD_CUSTOM_HID_REPORT_DESC_SIZE */

#define CUSTOM_HID2_DESCRIPTOR_TYPE                   0x21U
#define CUSTOM_HID2_REPORT_DESC                       0x22U

#define CUSTOM_HID2_REQ_SET_PROTOCOL                  0x0BU
#define CUSTOM_HID2_REQ_GET_PROTOCOL                  0x03U

#define CUSTOM_HID2_REQ_SET_IDLE                      0x0AU
#define CUSTOM_HID2_REQ_GET_IDLE                      0x02U
...
typedef enum
{
  CUSTOM_HID2_IDLE = 0U,
  CUSTOM_HID2_BUSY,
} CUSTOM_HID2_StateTypeDef;

typedef struct _USBD_CUSTOM_HID2_Itf
{
  uint8_t *pReport;
  int8_t (*Init)(void);
  int8_t (*DeInit)(void);
...
} USBD_CUSTOM_HID2_ItfTypeDef;

typedef struct
{
  uint8_t Report_buf[USBD_CUSTOMHID2_OUTREPORT_BUF_SIZE];
  uint32_t Protocol;
  uint32_t IdleState;
  uint32_t AltSetting;
  uint32_t IsReportAvailable;
  CUSTOM_HID2_StateTypeDef state;
} USBD_CUSTOM_HID2_HandleTypeDef;
/**
  * @}
  */
...
extern USBD_ClassTypeDef USBD_HID_CUSTOM2;

extern uint8_t CUSTOM_HID2_IN_EP;
extern uint8_t CUSTOM_HID2_OUT_EP;
extern uint8_t CUSTOM_HID2_ITF_NBR;
extern uint8_t CUSTOM_HID2_STR_DESC_IDX;
